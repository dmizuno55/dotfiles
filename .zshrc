...
#export PATH=/usr/local/bin:/usr/local/sbin:/usr/local/share:$NVM_HOME/$NODE_VERSION/bin:$EC2_HOME/bin:$PATH
...
export PORT=5000
export DATABASE_URL=postgres://oldgameuser:oldgamepass@localhost/oldgamedb
...
alias ED='/Applications/Emacs.app/Contents/MacOS/Emacs -nw --daemon'
alias EDD='/Applications/Emacs.app/Contents/MacOS/Emacs -nw --daemon --debug-init'
